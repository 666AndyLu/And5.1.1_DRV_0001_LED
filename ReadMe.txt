...
为了增加自己编写的驱动设备文件对于其他用户的读写权限
更改源码目录的/work/SC20_R01/out/target/product/msm8909/root/init.target.rc文件增加一行
#andy add led 2020.1.7
   chmod 0666 /dev/led1
...
c、原来的/work/SC20_R01/device/qcom/sepolicy/common/file_contexts
新的区别为，为了自己编写的应用程序对LED1设备驱动文件有读写权限
在dev node下面添加两行：
